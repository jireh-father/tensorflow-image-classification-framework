...
def build_model(inputs, config, is_training):
    ...
    print(net)
    sc1 = fire_module(net, 16, 64, 64, "fire2")
    print(net)
    net = fire_module(sc1, 16, 64, 64, "fire3")
    print(net)
    net += sc1
    net = fire_module(net, 32, 128, 128, "fire4")
    print(net)
    sc2 = tf.layers.max_pooling2d(inputs=net, pool_size=3, strides=2, name="pool2")
    net = fire_module(sc2, 32, 128, 128, "fire5")
    print(net)
    net += sc2
    sc3 = fire_module(net, 48, 192, 192, "fire6")
    print(net)
    net = fire_module(sc3, 48, 192, 192, "fire7")
    print(net)
    net += sc3
    net = fire_module(net, 64, 256, 256, "fire8")
    print(net)
    sc4 = tf.layers.max_pooling2d(inputs=net, pool_size=3, strides=2, name="pool3")
    net = fire_module(sc4, 64, 256, 256, "fire9")
    net += sc4
    print(net)
